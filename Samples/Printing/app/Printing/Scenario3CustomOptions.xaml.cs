...
namespace PrintSample
{
    ...
    class CustomOptionsPrintHelper : PrintHelper
    {
        ...
        void printDetailedOptions_OptionChanged(PrintTaskOptionDetails sender, PrintTaskOptionChangedEventArgs args)
        {
            ...
            {
                scenarioPage.DispatcherQueue.TryEnqueue(() =>
                {
        ...
        protected override RichTextBlockOverflow AddOnePrintPreviewPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
        {
            ...
            if (lastRTBOAdded == null)
            {
                ...
                scenarioImage.Visibility = ShowImage ? Microsoft.UI.Xaml.Visibility.Visible : Microsoft.UI.Xaml.Visibility.Collapsed;
                ...
                mainText.Visibility = ShowText ? Microsoft.UI.Xaml.Visibility.Visible : Microsoft.UI.Xaml.Visibility.Collapsed;
                continuationLink.Visibility = ShowText ? Microsoft.UI.Xaml.Visibility.Visible : Microsoft.UI.Xaml.Visibility.Collapsed;

                // Hide header if appropriate
                StackPanel header = (StackPanel)firstPage.FindName("Header");
                header.Visibility = showHeader ? Microsoft.UI.Xaml.Visibility.Visible : Microsoft.UI.Xaml.Visibility.Collapsed;
            }
