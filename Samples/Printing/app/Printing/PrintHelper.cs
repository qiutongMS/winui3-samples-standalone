...
namespace PrintSample
{
    public class PrintHelper
    {
        ...
        public virtual void RegisterForPrinting()
        {
            ...
            var hWnd = WindowNative.GetWindowHandle(Printing.App.MainWindow);
        ...
        protected virtual void CreatePrintPreviewPages(object sender, PaginateEventArgs e)
        {
            lock (printPreviewPages)
            {
                ...
                while (lastRTBOOnPage.HasOverflowContent && lastRTBOOnPage.Visibility == Microsoft.UI.Xaml.Visibility.Visible)
                {
        ...
        protected virtual RichTextBlockOverflow AddOnePrintPreviewPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
        {
            ...
            if (!textLink.HasOverflowContent && textLink.Visibility == Microsoft.UI.Xaml.Visibility.Visible)
            {
                StackPanel footer = (StackPanel)page.FindName("Footer");
                footer.Visibility = Microsoft.UI.Xaml.Visibility.Visible;
                PrintCanvas.UpdateLayout();
            }
