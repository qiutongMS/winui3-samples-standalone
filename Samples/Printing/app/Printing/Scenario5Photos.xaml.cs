...
namespace PrintSample
{
    ...
    class PhotosPrintHelper : PrintHelper
    {
        ...
        private void PrintDetailedOptionsOptionChanged(PrintTaskOptionDetails sender, PrintTaskOptionChangedEventArgs args)
        {
            ...
            {
                scenarioPage.DispatcherQueue.TryEnqueue(printDocument.InvalidatePreview);
            }
        }
        ...
        protected override void CreatePrintPreviewPages(object sender, Microsoft.UI.Xaml.Printing.PaginateEventArgs e)
        {
