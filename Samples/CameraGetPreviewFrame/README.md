# CameraGetPreviewFrame — WinUI 3 (migrated from UWP)
...
Capture a single still frame from the live camera preview via `MediaCapture.GetPreviewFrameAsync` for software inspection.
...
- UWP source: `..\..\..\uwp-samples-standalone\Samples\CameraGetPreviewFrame\cs\`
- Migrated by: Claude Opus 4.6 + the `winui-uwp-migration` skill (run33)
- Project file: `CameraGetPreviewFrame\CameraGetPreviewFrame.csproj`
