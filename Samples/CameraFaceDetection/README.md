# CameraFaceDetection — WinUI 3 (migrated from UWP)
...
Overlay live face-detection rectangles on the camera preview using `FaceDetectionEffect`.
...
- UWP source: `..\..\..\uwp-samples-standalone\Samples\CameraFaceDetection\cs\`
- Migrated by: Claude Opus 4.6 + the `winui-uwp-migration` skill (run33)
- Project file: `CameraFaceDetection\CameraFaceDetection.csproj`
