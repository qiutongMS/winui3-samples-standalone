# BasicSuspension — WinUI 3 (migrated from UWP)
...
Save and restore page state across app suspend, resume, and re-activation so users return to the same scenario page on next launch.
...
- UWP source: `..\..\..\uwp-samples-standalone\Samples\BasicSuspension\cs\`
- Migrated by: Claude Opus 4.6 + the `winui-uwp-migration` skill (run33)
- Project file: `BasicSuspension\BasicSuspension.csproj`
